        ...
        if (episodeId && !sv) {
            ...
            if (sv === 1) {
                ...
                if (idxAbyss != -1) {
                    ...
                    return res.status(200).send(` <iframe src=${src} frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`);
                }
            }
        }
